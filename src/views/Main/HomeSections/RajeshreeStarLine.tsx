...
import rajeshreeImage from "@/assets/rajshree.png";

const RajeshreeStarLine = () => {
  const results = [
    ...
    <div className="mt-6 border-2 border-purple-700 rounded-xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="w-full p-4 flex justify-center">
        <img
          ...
          className="w-72 h-72 object-cover rounded-full animate-spin-slow"
        />
      </div>
...
export default RajeshreeStarLine;
