...
const DailyGameChart = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto border-2 border-orange-600">
      ...
      <table className="w-full border-collapse text-center">
        <tbody>
          {rows.map((row, i) => (
            <tr key={i}>
              {/* Day */}
              <td className="border-2 border-orange-600  text-black w-[60px]">
                {row.day}
              </td>
              ...
              {row.data.map((cell, idx) => (
                <td
                  key={idx}
                  className="border-2 border-orange-600 p-0"
                >
                  <div className="flex h-full">
                    ...
                    <div className="w-[68%] flex flex-col">
                      <div className="flex items-center justify-center border-b-2 border-orange-600 text-base text-black leading-tight">
                        {cell[1]}
                      </div>
                      <div className="flex items-center justify-center text-sm  text-blue-800 leading-tight">
                        {cell[2]}
                      </div>
                    </div>
