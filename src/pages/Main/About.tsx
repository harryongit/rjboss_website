          ...
          <Card className="bg-white border-2 border-violet-400 shadow-lg">
            ...
            <CardContent className="p-3">
              <div className="space-y-3">
                {[
                  {
                    title: "What is SMBOSS.NET?",
                    text: "SMBOSS.NET is an informational platform that provides fast and regularly updated satta matka result information in a clean and easy-to-use format.",
                  },
                  {
                    title: "Our Purpose",
                  ...
                  },
                  {
                    ...
                    text: "SMBOSS.NET is strictly an entertainment and information-only website. We do not promote, support, or encourage gambling, betting, or any illegal activity.",
                  },
                  {
                    title: "Legal Notice",
