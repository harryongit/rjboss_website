  ...
  return (
    <Card className="bg-white border-2 border-indigo-400 shadow-lg">
      <CardHeader className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-2">
        <CardTitle className="text-center text-sm font-black tracking-wide">📖 ABOUT RJBoss SERVICE</CardTitle>
      </CardHeader>
      <CardContent className="p-3">
        <div className="space-y-3 text-xs text-gray-700 leading-relaxed">
          <p className="font-semibold text-indigo-900">Welcome to RJBoss, where entertainment takes center stage!</p>
          <p>RJBoss.Service is your ultimate destination for everything related to the fascinating world of the Satta Matka. As the RJBoss is a leading authority in the realm of Matka Games, this is your Go-To Platform for any reliable information along with accurate Matka Results and expert guidance.</p>
