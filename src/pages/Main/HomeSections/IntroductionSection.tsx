    ...
    <div className="max-w-4xl mx-auto space-y-6 my-6 px-2">
      ...
      <div className="border-2 border-blue-700 bg-[#f6c79b] rounded-xl overflow-hidden">
        <div className="max-h-[400px] overflow-y-auto px-4 py-6 text-[12px] font-bold leading-tight text-black space-y-4 text-center">
          ...
          <div className="space-y-1">
            <p><span className="text-red-700 font-black">Kalyan Matka:</span> Popular variant based on Bombay Cotton Exchange rates.</p>
            <p><span className="text-red-700 font-black">Mumbai Matka:</span> Classic format associated with the Mumbai market.</p>
            <p><span className="text-red-700 font-black">Rajdhani Matka:</span> Focuses on Rajdhani Cotton Exchange fluctuations.</p>
            <p><span className="text-red-700 font-black">Night Milan Matka:</span> Exciting evening variant for players after sunset.</p>
            <p><span className="text-red-700 font-black">Gali Deshawar:</span> Regional favorite with specific draw rules.</p>
          </div>
          ...
          <p>
            Matka game officially originated in India 1960s. It is a very popular lottery style which involves betting on number and combination and if the result drawn matched your combination the layer can win potential amount.
          </p>
          <p>
            Game Format: Played on weekends/holidays with numbers 0-9. Betting Process: Focuses on Jodi, Patti, and opening/closing times. Matka Draw: Combinations like 53 and 46 create the final result.
          </p>
        </div>
      </div>
      ...
      <div className="border-2 border-blue-700 bg-[#f6c79b] rounded-xl overflow-hidden">
        <div className="max-h-[400px] overflow-y-auto px-4 py-6 text-[12px] font-bold leading-tight text-black space-y-4 text-center">
          ...
          <p>
            Daily Satta Matka results are posted for Kalyan Open, Kalyan Close, Rajdhani, Milan, and other games. Users can check: <span className="text-white bg-blue-700 px-1">kalyan result</span>, <span className="text-white bg-blue-700 px-1">matka result</span>, <span className="text-white bg-blue-700 px-1">satta matka open</span>, <span className="text-white bg-blue-700 px-1">कल्याण रिजल्ट</span>.
          </p>

          <h3 className="text-red-700 font-black uppercase text-[14px] pt-2 italic underline underline-offset-2">PEOPLE ALSO SEARCH:</h3>
          <p className="italic text-blue-800">
            सत्ता मटका, सट्टा मटका कल्याण, सट्टा मट्टा, सट्टा मटका रिजल्ट, सट्का मटका कल्याण
          </p>

          <h3 className="text-red-700 font-black uppercase text-[14px] pt-2 italic underline underline-offset-2">KALYAN SATTA – THE HEART OF MATKA</h3>
          <p>
          ...
          <h3 className="text-red-700 font-black uppercase text-[14px] pt-2 italic underline underline-offset-2">TARA MATKA – A TRUSTED OPTION</h3>
          <p>
            Tara Matka is a growing game in the satta world. It has quick results and easy rules. Many use tara satta matka as an entry game. People rely on tara matka for fast money.
          </p>
